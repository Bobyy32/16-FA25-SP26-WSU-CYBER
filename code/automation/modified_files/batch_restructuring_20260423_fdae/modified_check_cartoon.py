...
def apply_cartoon(image):
    aug = iaa.Cartoon()
    augmented_images = [image] * 15
    return [image] + aug(images=augmented_images)


def draw_and_show(images, grid_rows, grid_cols):
    grid_image = ia.draw_grid(images, grid_rows, grid_cols)
