...
def fetch_search_datasets(config):
    ...
    if config.distributed:
        training_sampler = SubsetDistributedSampler(training_dataset, indices_list[:midpoint])
        validation_sampler = SubsetDistributedSampler(training_dataset, indices_list[midpoint:total_samples])
    else:
