...
class Parser(_Parser):
    ...
    def find_tags(self, tokens: Union[List[str], Any], **kwargs: Any) -> Any:
...
def tokenize(s: Union[str, Any], *args: Any, **kwargs: Any) -> List[Any]:
    """ Returns a list of sentences, where punctuation marks have been split from words.
    """
    return parser.find_tokens(s, *args, **kwargs)


def parse(s: Union[str, Any], *args: Any, **kwargs: Any) -> Union[str, Any]:
    """ Returns a tagged Unicode string.
    """
    return parser.parse(s, *args, **kwargs)


def parsetree(s: Union[str, Any], *args: Any, **kwargs: Any) -> Any:
    """ Returns a parsed Text from the given string.
    """
    return Text(parse(s, *args, **kwargs))


def suggest(w: Union[str, Any]) -> List[Tuple[Any, Any]]:
