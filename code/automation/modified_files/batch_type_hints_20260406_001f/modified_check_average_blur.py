...
from typing import List, Tuple, Sequence, Any, Union, overload
...
def main() -> None:
    ...
    k: List[Union[int, Tuple[int, int], Tuple[Tuple[int, int], Tuple[int, int]], Tuple[Tuple[int, int], int]]] = [
        1,
        2,
        4,
        8,
    ...
    for ki:
        aug: ia.Augmenter = iaa.AverageBlur(k=ki)
...
def process_image(image: np.ndarray, size: Union[Tuple[int, int], int]) -> np.ndarray:
    return image
