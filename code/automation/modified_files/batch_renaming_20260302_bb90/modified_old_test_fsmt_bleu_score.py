...
filepath = get_tests_dir() + "/test_data/fsmt/fsmt_val_data.json"
...
class ModelEvaluationTester(unittest.TestCase):
    ...
    @slow
    def test_bleu_metrics(self, language_pair, minimum_score):
        ...
        print(bleu_scores)
        self.assertGreaterEqual(bleu_scores["bleu"], minimum_score)