...
if __name__ == "__main__":
    ...
    G.add_argument('--pipeline_name', type=str, help='display pipeline_name.')
    G.add_argument('--name', type=str, help='display name.')
    G.add_argument('--object', type=str, help='display test object: time or memory.')
    ...
    print("Done." if (K == 'time' and test_time(I, J, L)) else (K == 'memory' and test_memory(I, J, L)) else print("Not support test object.\t", K))