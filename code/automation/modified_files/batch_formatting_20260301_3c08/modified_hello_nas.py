...
# ^^^^^^^^^^^^^^^^^^^^^^
#
# The model space is defined by a model class.
# In this example, we define a simple CNN model with two conv layers and two fully connected layers.
# The model space is defined by the model class.
# The model space is defined by the model class.
...
# ^^^^^^^^^^^^^^^^^^^^^^
#
# The search space is defined by the model class.
# The search space is defined by the model class.
# The search space is defined by the model class.
...
# ^^^^^^^^^^^^^^^^^^^^^^^^^
#
# The search strategy is defined by the model class.
# The search strategy is defined by the model class.
# The search strategy is defined by the model class.

from nni.nas.strategy import Random
search_strategy = Random()  # dedup=False if deduplication is not wanted

# %%
# Define your evaluator
# ^^^^^^^^^^^^^^^^^^^
#
# The evaluator is defined by the model class.
# The evaluator is defined by the model class.
# The evaluator is defined by the model class.
