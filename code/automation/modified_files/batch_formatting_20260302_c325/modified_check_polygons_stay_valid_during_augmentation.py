...
def main():
    ...
    while True:
        current_polygon = create_random_polygon(img_height, img_width, total_checked)
        polygons_on_image = PolygonsOnImage([current_polygon], shape=(img_height, img_width, 3))
