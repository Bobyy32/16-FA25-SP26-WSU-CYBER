...
def main(
    ...
    urls_small: Sequence[str]
    urls_medium: Sequence[str]
    urls_large: Sequence[str]
    image: Tuple[int, int, int, int]
    image_data: np.ndarray[Any, Any]
    augs: List[Sequence[Sequence[Sequence[Any]]]]
    img: Any
    ia: Any

    def _get_image(url: str) -> np.ndarray[Any, Any]:
    ...
    def _create_augmentation(
        ...
        return iaa.Cartoon()(images=images)

    image_data: np.ndarray[Any, Any] = _get_image(urls_medium[1])
    augs: List[Sequence[Sequence[Sequence[Any]]]] = [image_data] + _create_augmentation(
        images=image_data * 15
    )
    ia.imshow(
        ia.draw_grid(
            augs,
