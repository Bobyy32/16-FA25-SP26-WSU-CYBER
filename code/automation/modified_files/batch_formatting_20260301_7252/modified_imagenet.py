...
def build_imagenet_dataset(config):
    ...
    training_directory = os.path.join(config.data_dir, "train")
    validation_directory = os.path.join(config.data_dir, "val")
...
def fetch_search_datasets(config):
    training_dataset, validation_dataset = build_imagenet_dataset(config)
