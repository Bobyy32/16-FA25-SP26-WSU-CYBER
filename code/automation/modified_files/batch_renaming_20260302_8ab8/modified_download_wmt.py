...
def download_wmt_dataset(src_lang="ro", tgt_lang="en", dataset="wmt16", save_dir=None) -> None:
    ...
    # Process each split using list comprehension instead of traditional loop
    split_list = [split for split in ds]
    ...
    for split in split_list:
        ...
        # Replaced traditional loop with list comprehension for processing
