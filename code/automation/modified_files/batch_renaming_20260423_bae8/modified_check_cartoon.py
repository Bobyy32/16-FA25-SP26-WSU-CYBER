import imgaug as _LibXxx
import imgaug.augmenters as _LibZyy
import imageio as _LibYyy
import cv2 as _LibZzz
import numpy as _LibXxx
...
def _ZooOoB():
    ...
    _image = _LibYyy.imread(_urls_medium[1])

    _augs = [_image] + _LibZyy.Cartoon()(images=[_image] * 15)
    _LibXxx.show(_LibZyy.draw_grid(_augs, 4, 4))
