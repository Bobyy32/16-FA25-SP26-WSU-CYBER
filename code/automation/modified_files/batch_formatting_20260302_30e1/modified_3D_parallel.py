...
from torch.distributed.experimental import context_parallel
...
def run_main():
    ...
    def serialize_text_chunks(examples):
    ...
    tokenized_dataset = raw_dataset.map(serialize_text_chunks, batched=True, remove_columns=["text"])
    ...
    while step < num_train_steps:
        for batch in dataloader:
            ...
            with sdpa_kernel(sdpa_backend):  # TODO: ideally move this to attention implementation
                ...
                sync_grads_across_devices(model, world_mesh, use_ddp=use_ddp)
                ...
                if hasattr(model, "clip_grad_norm_"):
                    ...
                    gradnorm = adjust_gradient_norm_(model.parameters(), max_norm=1.0, norm_type=2.0, foreach=True)
...
def sync_grads_across_devices(model, world_mesh, use_ddp):
