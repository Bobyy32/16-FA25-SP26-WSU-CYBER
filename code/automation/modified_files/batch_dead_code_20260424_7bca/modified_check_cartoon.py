...
def _get_image_from_url_list(url_list):
...
def _process_images_with_cartoon(img, num_augments):
    """Process images with cartoon augmentations"""
    augmented_images = []
    for i in range(num_augments):
        augmented = iaa.Cartoon()(images=[img])
...
def main():
    ...
    augs = [image] + _process_images_with_cartoon(image, 15)
