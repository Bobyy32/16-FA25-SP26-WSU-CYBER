...
def _helper_function_one():
    pass


def _helper_function_two():
    return None


def _helper_function_three():
    _unused = None
    return None
...
def main():
    ...
    _unused = ia.imshow(ia.draw_grid(augs, 4, 4))
