...
with open(file_path, encoding="utf-8") as file_handle:
    bleu_dataset = json.load(file_handle)
...
class ModelEvaluationTest(unittest.TestCase):
    ...
    def test_bleu_metrics(self, language_pair, minimum_bleu):
        ...
        source_sentences = bleu_dataset[language_pair]["src"]
        target_sentences = bleu_dataset[language_pair]["tgt"]
        ...
        score_results = calculate_bleu(decoded_texts, target_sentences)
        print(score_results)
        self.assertGreaterEqual(score_results["bleu"], minimum_bleu)