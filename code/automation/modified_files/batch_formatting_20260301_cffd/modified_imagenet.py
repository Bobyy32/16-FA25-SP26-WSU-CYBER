...
def build_image_folder_dataset(configuration):
...
def fetch_search_datasets(configuration):
    training_dataset, validation_dataset = build_image_folder_dataset(configuration)
    total_samples = len(training_dataset)
    sample_indices = list(range(total_samples))
    middle_point = int(numerical_array.floor(0.5 * total_samples))
