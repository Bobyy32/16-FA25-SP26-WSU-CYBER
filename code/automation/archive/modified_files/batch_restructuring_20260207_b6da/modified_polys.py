...
class Polygon(object):
    ...
    def to_keypoints(self):
        ...
        list of imgaug.augmentables.kps.Keypoint
            Exterior vertices as :class:`~imgaug.augmentables.kps.Keypoint` objects.
    ...
    def to_list(self):
        """Convert this polygon to a list of points.

        Returns
        -------
        list of tuple of float
            List of points (x, y) that make up this polygon.

        """
        return list(self.exterior)
    ...
    def deepcopy(self):
        ...
        -------
        imgaug.augmentables.polys.Polygon
            Deep copy of this polygon.

        """
        return Polygon(self.exterior, label=self.label)

    def __getitem__(self, indices):
        """Get the point(s) with given indices.

        Returns
        -------
        list of tuple of float
            Point(s) with given indices.

        """
        return self.exterior[indices]

    def __iter__(self):
        """Iterate over the points in this polygon.

        Yields
        ------
        tuple of float
            A point (x, y) in this polygon.
            The order is identical to the order in the exterior list
    ...
    def __str__(self):
        return "Polygon(%s, label=%s)" % (str(self.exterior), self.label)
...
class MultiPolygon(object):
    ...
    def __len__(self):
        ...
        -------
        int
            Number of polygons in this MultiPolygon.
    ...
    def __str__(self):
        return "MultiPolygon(%s)" % (str(self.geoms),)