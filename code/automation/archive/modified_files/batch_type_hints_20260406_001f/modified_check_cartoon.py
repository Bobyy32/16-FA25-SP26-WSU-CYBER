...
def main() -> Optional[Any]:
    ...
    urls_medium: List[Union[str, Any]] = [
        "https://upload.wikimedia.org/wikipedia/commons/thumb/0/08/"
        "Physicist_Stephen_Hawking_in_Zero_Gravity_NASA.jpg/"
    ...
    image: np.ndarray[Any, np.int32] = imageio.imread(urls_medium[1])

    augs: List[Union[np.ndarray[Any, np.int32], Any]] = [image] + iaa.Cartoon()(images=[image] * 15)
