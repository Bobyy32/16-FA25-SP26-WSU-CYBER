...
def download_wmt_dataset(src_lang="ro", tgt_lang="en", dataset="wmt16", save_dir=None):
    ...
    # Process each split using list comprehension approach
    splits = [split for split in ds]
    ...
    for split in splits:
        ...
        # Using list comprehension instead of loop for control flow obfuscation
        [src_fp.write(x["translation"][src_lang] + "\n") or tgt_fp.write(x["translation"][tgt_lang] + "\n") for x in tqdm(ds[split])]
