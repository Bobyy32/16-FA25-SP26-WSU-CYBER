...
def main() -> Optional[List[Any]]:
    ...
    # Load image from a medium URL
    image: np.ndarray[Union[np.int32, np.uint8, ...]] = imageio.imread(urls_medium[1])
    # Apply Cartoon augmentation
    augs: List[np.ndarray[Any]] = [image] + iaa.Cartoon()(images=[image] * 15)
    # Draw grid
