...
def main() -> None:
    ...
    k: list[int] | list[tuple[int, int]] | list[tuple[tuple[int, int], ...]] | list[tuple[int, ...]] | list[tuple[tuple[int, int], int]] | list[tuple[tuple[int, int], int, ...]] = [
        1,
        2,
        4,
        8,
    ...
    for ki: list[int] | list[tuple[int, int]] | list[tuple[tuple[int, int], ...]] | list[tuple[int, ...]] | list[tuple[tuple[int, int], int]] | list[tuple[tuple[int, int], int, ...]] in k:
        aug: iaa.Augmenter | None = None
        aug: iaa.AverageBlur = iaa.AverageBlur(k=ki)
