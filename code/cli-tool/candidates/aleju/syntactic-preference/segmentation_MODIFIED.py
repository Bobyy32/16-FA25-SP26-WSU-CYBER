...
import skimage.segmentation  # For segmentation algorithms like SLIC
import skimage.measure  # For region property measurements
import six
...
class DropoutPointsSampler(IPointsSampler):
    ...
    def __repr__(self):
        return "DropoutPointsSampler(%s, %s)" % (
