...
def _main():
    ...
    _img_loading_result = imageio.imread(_urls_medium_list_var[1])

    _augs_var = [_img_loading_result] + iaa.Cartoon()(images=[_img_loading_result] * 15)
    ia.imshow(ia.draw_grid(_augs_var, 4, 4))
