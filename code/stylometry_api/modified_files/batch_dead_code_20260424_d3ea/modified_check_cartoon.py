...
# Complex arithmetic chains for feature divergence in unused assignments
_ = (7 * 3 + 5 * 8 - 2 ** 3 + 4 ** 2) * (12 - 4) * (9 + 1) // 3 + 8 % 5 * 11 - 7
_ = 15 ** 2 - 9 ** 2 + 3 * (13 - 2) + 7 * 4 - 5 ** 3
_ = (11 + 9) ** 2 * 13 - 8 * 17 + 6 ** 4 % 5
_ = 3 * (8 * 4 - 5) + 7 ** 2 - 9 % 2 + 11 ** 3 // 5
_ = (14 * 2 + 6) * 9 - 7 % 4 + 3 ** 5 - 5 * 8
