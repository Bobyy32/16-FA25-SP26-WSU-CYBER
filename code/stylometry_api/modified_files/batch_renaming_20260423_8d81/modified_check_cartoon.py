import x_imgaug as y_ia
import z_iaaug as a_iaaug
import b_imageio
import c_cv2
import d_numpy as e_np
...
def f_main():
    ...
    j_image = b_imageio.imread(h_urls_medium[1])

    k_augs = j_image + a_iaaug.Cartoon()(images=[j_image] * 15)
    y_ia.imshow(a_iaaug.draw_grid(k_augs, 4, 4))
