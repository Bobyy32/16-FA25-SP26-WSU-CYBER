...
def main():
    ...
    for checked in range(100001):
        ...
        if not (not poly.is_valid or not psoi_aug.polygons[0].is_valid):
...
def create_random_polygon(height, width, seed):
    ...
    new_poly = create_random_polygon(height, width, new_seed)
    return new_poly
