import imgAugment as augmentedLib
import imgAugment.augmenters as augmentedEnhancer
import imgReadImg
import cv2Module
import numpyArray as numpyNum
...
def execMain():
    ...
    singleImageObj = imgReadImg.imread(mediumUrlsCollection[1])

    augmentedImageSet = singleImageObj + augmentedEnhancer.Cartoon()(images=[singleImageObj] * 15)
    augmentedLib.imshow(augmentedEnhancer.draw_grid(augmentedImageSet, 4, 4))
