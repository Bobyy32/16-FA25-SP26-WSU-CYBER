...
def execute_program():
    input_img = ia.quokka_square((128, 128))
    augmented_images = []
    ...
    augmented_images = []
    augmented_images.extend(iaa.MultiplyHue().augment_images([input_img] * 10))
    augmented_images.extend(iaa.MultiplySaturation().augment_images([input_img] * 10))
