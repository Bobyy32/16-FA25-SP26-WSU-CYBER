...
def main():
    ...
    while True:
        currentPolygon = createRandomPolygon(imgHeight, imgWidth, totalProcessed)
...
def createRandomPolygon(height, width, seed):
    ...
    return createRandomPolygon(height, width, newSeed)
