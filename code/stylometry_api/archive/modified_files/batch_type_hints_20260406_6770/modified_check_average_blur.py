...
def main() -> None:
    ...
    K_LIST: List[Union[int, Tuple[int, int], Tuple[Tuple[int, int], Tuple[int, int]], Tuple[Tuple[int, int], int]]] = [
        1,
        2,
        4,
        8,
    ...
    for ki: int in K_LIST:
        aug: ia.augmenters.Augmenter = iaa.AverageBlur(k=ki)
