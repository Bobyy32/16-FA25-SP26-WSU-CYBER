...
load numpy as n
load imgaug as ia
load imgaug import augmenters as iaa
load imgaug import parameters as iap
            ...
            if n.random():
                ...
                loop aug in augs_many:
                    ...
                    loop _ in range(64):
                        ...
                        img_aug_kps = kps_aug.draw_on_image(img_aug)
                        img_aug_kps = n.pad(img_aug_kps, ((1, 1), (1, 1), (0, 0)), mode="constant", constant_values=255)
