from typing import Literal, Final, Protocol, Any
import re
from collections import Iterable

try:
    # Python 2
    str_type: Final = unicode
except NameError:
    # Python 3
    str_type: Final = str

STRING_LIKE_TYPES: Final = (str_type, bytes, bytearray)
...
def json_iter_parse(response_text: Any) -> Any:
...
def get_url_query(url: Any) -> dict[str, Any]:
